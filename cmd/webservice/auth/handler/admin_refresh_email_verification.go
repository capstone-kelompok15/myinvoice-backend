...
func (h *authHandler) RefreshAdminEmailVerificationCode() echo.HandlerFunc {
	return func(c echo.Context) error {
		var req dto.AdminRefreshEmailVerificationCode
		err := c.Bind(&req)
		if err != nil {
		...
		err = h.service.RefreshAdminEmailVerificationCode(c.Request().Context(), req.Email)
		if err != nil {
